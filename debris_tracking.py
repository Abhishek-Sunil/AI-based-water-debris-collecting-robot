...
import sys
sys.path.insert(0, '/home/pi/Desktop/miniproject/robotics-level-4/earthrover')
import util as ut
ut.init_gpio()
...
model_dir = '/home/pi/Desktop/miniproject/robotics-level-4/all_models'
...
arr_valid_objects=['leaf','banana','bottle' ]
